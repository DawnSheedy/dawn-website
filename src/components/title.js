...
const Title = (props) => {
    return (<div>
        ...
        <h1 className="App-subline"><span style={{ animationDelay: "300ms" }} className="App-subline title-block entry-anim">[she/they]</span></h1>
        <span style={{ animationDelay: "450ms" }} className="subtitle entry-anim">Software Engineer // Seattle, WA</span>
